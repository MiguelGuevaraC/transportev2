...
class UbigeoController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/departments",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/provinces/{departmentId}",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/districts/{provinceId}",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/ubigeos",
