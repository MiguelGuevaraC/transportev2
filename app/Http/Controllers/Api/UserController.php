...
class UserController extends Controller
{
     ...
     * Get all Users
     * @OA\Get (
     *     path="/transportev2/public/api/user",
     *     tags={"User"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Response(
     *         response=200,
     ...
     *             @OA\Property(property="first_page_url", type="string", example="http://develop.garzasoft.com/transportev2/public/api/user?page=1"),
     *             @OA\Property(property="from", type="integer", example=1),
     *             @OA\Property(property="next_page_url", type="string", example="http://develop.garzasoft.com/transportev2/public/api/user?page=2"),
     *             @OA\Property(property="path", type="string", example="http://develop.garzasoft.com/transportev2/public/api/user"),
    ...
    /**
     * @OA\Post(
     *     path="/transportev2/public/api/login",
     *     summary="Login user",
     *     tags={"Authentication"},
     ...
     * @OA\Get (
     *     path="/transportev2/public/api/user/{id}",
     *     tags={"User"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *         name="id",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/authenticate",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/logout",
     *     tags={"Authentication"},
     *     summary="Logout",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/searchByDni/{dni}",
     *     tags={"Search"},
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/searchByRuc/{ruc}",
     *     tags={"Search"},
