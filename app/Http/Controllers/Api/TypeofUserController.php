...
class TypeofUserController extends Controller
{
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/typeofUser",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/typeofUser/{id}",
...
/**
 * @OA\Put(
 *     path="/transportev2/public/api/setAccess/{typeUserId}",
 *     tags={"TypeofUser"},
 ...
 */
     ...
     *
     * @OA\Get(
     *     path="/transportev2/public/api/getAccess/{typeUserId}",
     *     tags={"TypeofUser"},
