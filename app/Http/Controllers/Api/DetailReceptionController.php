...
class DetailReceptionController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/detailReception",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/detailReception/{id}",
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/detailReceptionForReception/{id}",
     *     summary="Get a detailReception by ID",
     *     tags={"Detail Reception"},
    ...
    /**
     * @OA\Get(
     *     path="/transportev2/public/api/detailReceptionWithoutProgramming",
