...
/**
 * @OA\Schema(
 *     schema="SeccionRequest",
 *     title="SeccionRequest",
 *     description="Request model for Seccion information with filters and sorting",
...
class StoreSeccionRequest extends StoreRequest
{
    /**
