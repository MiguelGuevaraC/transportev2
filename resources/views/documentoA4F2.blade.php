...
<body>
    ...
    <div class="content">
        ...
        <?php
        $totalDetalle = array_sum(array_column($detalles, 'precioventaunitarioxitem'));
        
        $totalPU = array_sum(array_column($detalles, 'precioventaunitarioxitem'));
        $totalVV = $totalPU / 1.18; // Cálculo del total de venta sin IGV
        
        // Obtener todas las guías separadas por comas
        $guias = implode(', ', array_column($detalles, 'guia'));
        ?>
        ...
        <table class="tableDetail font-12">
            ...
            <tr>
                ...
                <td class="font-8" style="text-align: justify">Servicio de transportes de las Guías <?php echo $guias; ?>
                </td>
                <td class="center font-10"><?php echo number_format($totalPU, 2); ?></td>
                <td class="center font-10"><?php echo number_format($totalVV, 2); ?></td>
            </tr>
        </table>
