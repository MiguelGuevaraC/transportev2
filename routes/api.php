...
Route::group(["middleware" => ["auth:sanctum"]], function () {
    ...
    Route::get('addressForPersonPlace/{idPersona}', [AddressController::class, 'addressForPersonPlace']);
    ...
    require __DIR__ . '/Api/PlanillaApi.php';           //PLANILLA ASISTENCIA / FALTAS
    ...
    require __DIR__ . '/Api/GroupMenuApi.php'; //VEHICLE


    require __DIR__ . '/Api/ConceptTireOperationApi.php'; //CONCEPTOS DE TIRE OPERATIONS

    require __DIR__ . '/Api/DocAlmacenApi.php'; //DOC ALMACEN 

    require __DIR__ . '/Api/DocAlmacenDetailApi.php'; //DETALLES DOC ALMACEN
    require __DIR__ . '/Api/TireMeasureApi.php'; //DETALLES TIRE MEASURE

    require __DIR__ . '/Api/PropuestaFuncionalidadApi.php';
